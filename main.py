...
with gr.Blocks(css=css) as interface:
    ...
    output_name = 'Result',
    output_directory = DEF_OUTPUT_PATH
    keep_output_sequence = False,
    swap_option = swap_options_list[0],
    age = 25,
    distance_slider = 0.6,
    face_enhancer_name = "NONE",
    enable_face_parser_mask = False,
    ...
    #     source_image_input,
    #     "Result",  # output_name
    #     False,     # keep_output_sequence
    #     swap_options_list[0],  # swap_option
    #     25,        # age
    #     0.6,       # distance_slider
    #     "NONE",    # face_enhancer_name
    #     False,     # enable_face_parser_mask
    #     MASK_INCLUDE,
    #     MASK_SOFT_KERNEL,
    #     MASK_SOFT_ITERATIONS,
    #     MASK_BLUR_AMOUNT,
